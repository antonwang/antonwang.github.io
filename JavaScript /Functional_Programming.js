...
It takes an argument for the delimiter that is used to separate the array elements in 
the string.
...
"I-like-Star-Wars" would be converted to "I like Star Wars". For this challenge,
...
follow functional programming principles. We've also learned about reduce, which is 
a powerful method used to reduce problems to simpler forms. From computing averages 
to sorting, any array operation can be achieved by applying it. Recall that map and
...
}   //trim removes spaces around the string; /\s+/ means more than 1 white spaces
// Add your code above this line
...
For example, the following code would check if every element in the numbers array is
 less than 10:  */
