...
<body>
  <ul></ul>
  <script>
    const dataset = ["a", "b", "c"]; d3.select("ul").selectAll("li")
    .data(dataset) .enter() .append("li") .text("New item");
  </script>
</body>;
...
<body>
  <script>
    ...
    d3.select("body").selectAll("h2")
      ...
      .enter()
      .append("h2")
      .text(d => d + " USD"); // display each value from the dataset array with a single space and "USD"
...
<body>
  <script>
    ...
    d3.select("body").selectAll("h2")
      ...
      //use a callback function in the style() method and include the conditional logic
      .style("color", d => {
        if (d < 20) {return "red"}
        else return "green"
      });
...
<body>
  <script>
    ...
    const svg = d3.select("body")
                  ...
                  .attr("height", h)
                  // Add your code below this line
                  .append("rect")  //adding a rect shape to the svg using append()
                  .attr("width", "25")
                  .attr("height", "100")
                  .attr("x", "0")
                  .attr("y", "0")
...
<body>
  <script>
    ...
    //all stacked on top of each other bc every bar is placed in the upper-left corner (0,0)
       // Add your code above this line
       .attr("x", 0)
       .attr("y", 0)
       .attr("width", 25)
...
<body>
  <script>
    ...
    svg.selectAll("rect")
       ...
       .enter()
       .append("rect")
       .attr("x", (d, i) => { //d is the data point value, i is the index of the data point in the array
         // Add your code below this line
         return i*30;
...
<body>
  <script>
    ...
    svg.selectAll("rect")
       ...
       .attr("height", (d, i) => {
         // Add your code below this line
       return d*3 //multiplying all data points by the same constant scales the data (like zooming in)
         // Add your code above this line
       });
  </script>
</body>
...
<body>
  <script>
    ...
    svg.selectAll("rect")
       ...
       .attr("y", (d, i) => {
         // Add your code below this line
        return h - 3*d //setting the y-axis of each bar
         // Add your code above this line
       })
       .attr("width", 25)
       .attr("height", (d, i) => 3 * d); // pushes the rectangle bottom of y axis
  </script>
</body>
...
<body>
  <script>
    ...
    svg.selectAll("rect")
       ...
       .attr("height", (d, i) => 3 * d)
       // Add your code below this line
        .attr("fill", "navy") //a rect shape is colored with the fill attribute
       // Add your code above this line
  </script>
</body>
...
<body>
  <script>
    ...
    svg.selectAll("text")
       ...
       .enter()
       // Add your code below this line
       .append("text")  //append text nodes to the svg
       .attr("x", (d, i)=> i * 30)
       .attr("y", (d, i)=> h-3-3*d) //label sit 3 units higher than the bar
       .text(d=>d)  //set the label equal to the data point value
       // Add your code above this line
  </script>
<body>
...
<body>
  <script>
    ...
    svg.selectAll("text")
       ...
       .attr("y", (d, i) => h - (3 * d) - 3)
       // Add your code below this line
        .attr("fill", "red")  //fill attribute sets the color of the text for a text node. 
...
<body>
  <script>
    ...
    svg.selectAll("rect")
       ...
       .attr("fill", "navy")
       // Add your code below this line
      .attr("class", "bar")  //adding a class of bar to all "rect" - note that bar:hover is also called
       // Add your code above this line
...
<body>
  <script>
    ...
    svg.selectAll("rect")
       ...
       .attr("class", "bar")
       // Add your code below this line
      .append("title").text(d=>d) //Append a title element under each rect node and text displays data value
       // Add your code above this line
...
<body>
  <script>
    ...
    svg.selectAll("circle") 
      ...
      .data(dataset)
      .enter()
      .append("circle")  //creates circle elements for each point in the dataset
       // Add your code above this line
...
<body>
  <script>
    ...
    svg.selectAll("circle")
       ...
       // Add your code below this line
      .attr("cx", d => d[0]) 
      .attr("cy", d => h - d[1]) // to show the chart right-side-up and not inverted
      .attr("r", 5)
       // Add your code above this line
...
<body>
  <script>
    ...
    svg.selectAll("text")
       ...
       .append("text")
       // Add your code below this line
       .text (d => d[0] + ", " + d[1]) //adding text to the circle elements
       .attr("x", (d, i) => d[0]+5)
       .attr("y", (d, i) => h - d[1])
...
<body>
  <script>
    // Add your code below this line
    //create the scale; domain covers the set of input values; range covers the set of output values
...
const xScale = d3.scaleLinear()
  .domain([0, d3.max(dataset, (d) => d[0])]) //domain goes from 0 to the max in d[0]
...
<body>
  <script>
    ...
    // scaling function of xScale and yScale
    const xScale = d3.scaleLinear()
                     .domain([0, d3.max(dataset, (d) => d[0])])
                     .range([padding, w - padding]);
...
<body>
  <script>
    ...
    //creating scaling functions - xScale and yScale
    const xScale = d3.scaleLinear()
                     .domain([0, d3.max(dataset, (d) => d[0])])
                     .range([padding, w - padding]);
    ...
    const xAxis = d3.axisBottom(xScale); //creating the xAxis using axisBottom method and xScale function
    // Add your code below this line
    const yAxis = d3.axisLeft(yScale); //creating the yAxis using axisLeft method and yScale function
    // Add your code above this line
    ...
    // Add your code below this line - append("g") for adding axes; 'g' means group
   svg.append("g")
